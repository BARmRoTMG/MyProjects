$(function () {
    ...
    $('.page-contrtol form #selectPersonType').change(function (e) {
        $(this).closest('form').find('#personType').val($(e.target).val()).change();
    })
    $('.page-contrtol form #selectPersonType option').each(function () {
        var selected = $(this).closest('form').find('#personType').val();
